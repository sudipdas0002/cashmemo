...
function toggleElements() {
  var deleteButton = document.querySelectorAll("button[onclick='deleteRow(this)']");
  var addButton = document.querySelector("button[onclick='addRow()']");
  var totalAmountButton = document.querySelector("button[onclick='updateTotalAmount()']");

    addButton.style.display = 'inline-block'; // Restore the original display property
    totalAmountButton.style.display = 'inline-block'; // Restore the original display property
  }
function printPage() {
  toggleElements();
  window.print();
