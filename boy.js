...
function addRow() {
  ...
  newRow.innerHTML = `
    ...
    <td class="wide-box"><input type="text-1" name="item-new"></td>
    <td class="smaller-box"><input type="number-1" name="quantity-new" oninput="calculateTotal(this)"></td>
    <td class="small-box"><input type="number-2" name="price-new" oninput="calculateTotal(this)"></td>
    <td class="medium-box"><input type="number-2" name="total-new"></td>
